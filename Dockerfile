...
RUN Rscript -e 'remotes::install_github("Thinkr-open/golem@cc2ba3dcb7ea95cffcf36627d98f36d7d9d6f02a")'
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');meu.golem::run_app()"
